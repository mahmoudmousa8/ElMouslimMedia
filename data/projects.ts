...
export const projects: Project[] = [
  ...
  {
    title: "Almahrat Gift & Charity Store",
    slug: "almahrat-store",
    category: "Websites",
    shortDescription: "Innovative digital gifting and donation portal generating instant digital gift cards for charitable causes.",
    technologies: ["E-Commerce", "Payment Integration", "Digital Gifting"],
    image: "/images/projects/almahrat-store.webp",
    projectUrl: "https://almahrat.sa/",
    published: true,
    sample: false,
    code: "AM",
    tone: "amber",
  ...
  {
    title: "Neonatal Care Charity Association",
    slug: "neonatal-care",
    category: "Websites",
    shortDescription: "Healthcare non-profit portal dedicated to infant incubators, medical care, and newborn support in Makkah.",
    technologies: ["Charity Web", "Google Tag Manager", "SEO Audit"],
    image: "/images/projects/neonatal-care.webp",
    projectUrl: "https://www.neonatal-mkh.org.sa/",
    published: true,
    sample: false,
    code: "NC",
    tone: "ember",
